...
function seznam_hracu_function($atts, $content = null) {
   ...
   $return_string = '<table class="sortable seznam-hracu-tabulka">';  
...
function video_o_hraci_function($atts, $content = null) {
...
function register_shortcodes_hraci(){
   ...
   add_shortcode('video_o_hraci', 'video_o_hraci_function');
