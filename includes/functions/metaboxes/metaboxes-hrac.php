...
?>
 ...
 <table>
      ...
      <tr>
          ...
          <td style="padding-top: 20px; padding-left: 0px;"><h2><strong>Statistiky hráče</h2></strong></td>
          
      </tr>
      
      <tr>
      
          <td>Sezóny v Pasos Pardubice (oddělit čárkou)</td>
          <td><input style="width: 160px;" type="text" name="number_of_sezona" id="number_of_sezona" value="<?php if ( isset ( $values['number_of_sezona'] ) ) { echo $values['number_of_sezona'][0]; }else{echo "";}; ?>" /></td>
